		...
		// create session factory
				...
				try {
					...
					if (instructor != null) {
						...
						// updating instructorDetail object
						InstructorDetail detail = instructor.getInstructorDetailId();
						detail.setYoutubeChannel("full stack developer");
						
						// updating instructor object
